...
public class CandidatureController {
    ...
    private void afficherCandidatures() throws SQLException {
        ...
        colUniversity.setCellValueFactory(cellData -> {
            University university = cellData.getValue().getUniversity();
        ...
        colCv.setCellValueFactory(cellData ->
                new javafx.beans.property.SimpleStringProperty(getFileName(cellData.getValue().getCv())));
    ...
    private void handleDelete() {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            try {
                ...
                afficherCandidatures(); // Rafraîchir la table après suppression
            } catch (SQLException e) {
                e.printStackTrace();
